            ...
            <ul class="menu">
                <?php if(Auth::check()): ?>
                    <li style="color: white">
                        <?php
                        echo "<a href='/myaccount'>".Auth::user()->name."</a>";?><?php else: ?>  <a href ="/login">Login |</a>
                ...
                <?php if(Auth::check()): ?>
                    <li>
                        <a href ="/logout">logout</a>   <?php else: ?>  <a href ="/register">Register |</a>
                    </li>
                <?php endif; ?>
...
<div id="copyright">
    <div class="container">
        ...
        <div class="col-md-6">
            <?php /*<p class="pull-right">By <a href="http://bootstrapious.com/e-commerce-templates">WE_SEP</a> with support from <a href="http://kakusei.cz">Designové předměty</a>*/ ?>
