...
<div id="main-container" class="container">
    ...
    <div id="template-designer" class="fpd-shadow-1">
        <?php if(isset($backDets)): ?>
            <?php foreach($backDets as $dets): ?>
                <div class="fpd-product" title="<?php echo $dets->name; ?>-Front" data-thumbnail="img/cusTempEng/Background/<?php echo $dets->fileFront; ?>">
                    <img src="img/cusTempEng/Background/<?php echo $dets->fileFront; ?>" title="Base" data-parameters='{"x": 0, "y": 0, "colors": "#000000", "price": <?php echo $dets->price; ?>, "draggable": true,"resizable": true}' />
                    ...
                    <div class="fpd-product" title="<?php echo $dets->name; ?>-Back" data-thumbnail="img/cusTempEng/Background/<?php echo $dets->fileBack; ?>">
                        <img src="img/cusTempEng/Background/<?php echo $dets->fileBack; ?>" title="Base" data-parameters='{"x": 0, "y": 0, "colors": "Base", "price": <?php echo $dets->price; ?>,"draggable": true,"resizable": true}' />
                    </div>
                </div>
            <?php endforeach; ?>
        <?php endif; ?>
        ...
        <div class="fpd-design">
            <?php if(isset($desDets)): ?>
                <?php foreach($desDets as $catkey => $catDets ): ?>
                    <div class="fpd-category" title="<?php echo $catkey; ?>">
                        <?php foreach($catDets as $dets): ?>
                        <img src="img/cusTempEng/Designs/<?php echo $dets->fileDesign; ?>" title="<?php echo $dets->name; ?>" data-parameters='{"zChangeable": true, "x": 215, "y": 200, "colors": "#000000", "removable": true, "draggable": true, "rotatable": true, "resizable": true, "price": <?php echo $dets->price; ?>, "boundingBox": "Base", "autoCenter": true}' />
                        <?php endforeach; ?>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
