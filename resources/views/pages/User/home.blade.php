...
@section('content')
    ...
    @if (session('msg'))
        <script>
            sweetAlert('{{ session('msg') }}', "You clicked the button!", "error");
        </script>
    @endif
            ...
            <div class="container">
                <div class="col-md-12">
                    <div id="main-slider">
                        ...
                        <div class="item">
                            <img class="img-responsive" src="img/slide_10.jpg" alt="">
                        </div>
                        <div class="item">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        ...
                                        <div class="back">
                                            <a href="#">
                                                <img src="img/1_2.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        ...
                                        <div class="back">
                                            <a href="#">
                                                <img src="img/2_2.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        ...
                                        <div class="back">
                                            <a href="#">
                                                <img src="img/3_2.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="text">
                                    <h3><a href="#">Black Blouse Versace</a></h3>
                                    <p class="price">$143.00</p>
                                </div>
                                <!-- /.text -->
                            </div>
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        ...
                                        <div class="back">
                                            <a href="#">
                                                <img src="img/7_2.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="text">
                                    <h3><a href="#">White Blouse Versace</a></h3>
                                    <p class="price">$143.00</p>
                                </div>
                                <!-- /.text -->
                ...
                <div class="col-md-12">
                    <div class="box slideshow">
                        ...
                        <div id="get-inspired" class="owl-carousel owl-theme">
                            <div class="item">
                                <a href="#">
                                    <img src="img/slide_1.jpg" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="img/slide_13.jpg" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="img/slide_12.jpg" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                        </div>
                    </div>
