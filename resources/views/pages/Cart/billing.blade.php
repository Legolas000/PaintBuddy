...
//require_once ("paypalfunctions.blade.php");

public_path('paypalfunctions.blade.php');
...
if ( $PaymentOption == "PayPal")
{
    ...
    //'------------------------------------
    $returnURL = "http://localhost/PaintBuddyIntegration/public/orderConfirm";
    ...
    //' This is set to the value entered on the Integration Assistant
    //'------------------------------------
    $cancelURL = "http://localhost/PaintBuddyIntegration/public/";
