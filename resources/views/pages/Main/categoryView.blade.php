                        ...
                        @foreach($imDets as $dets)
                            <div class="col-md-4 col-sm-3">
                                <div class="product">
                                        ...
                                        <div class="flipper">
                                            <div class="front">
                                                <a href="/viewDets.{!! $dets->itID !!}">
                                                    <img src="img/tempEng/{{$dets->imPath}}" alt="" class="img-responsive cat-item">
                                                </a>
                                            </div>
                                            <div class="back">
                                                <a href="/viewDets.{!! $dets->itID !!}">
                                    ...
                                    <div class="text">
                                        <h3><a href="/viewDets.{!! $dets->itID !!}">{!! $dets->itDescrip !!}</a></h3>
                                        <p class="price">Rs.{!! $dets->price !!}</p>
                                        <p class="buttons">
