            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div id="artOrdersTable">
                        <button type="button" onclick="document.location.href='{{action('Artist\ArtsOrdersController@ViewAOrders')}}'" class="btn btn-info col-md-4" role="button">All Orders</button>
                        <button type="button" onclick="document.location.href='{{action('Artist\ArtsOrdersController@ViewCOrders')}}'" class="btn btn-info col-md-4" role="button">Completed Orders</button>
                        <button type="button" onclick="document.location.href='{{action('Artist\ArtsOrdersController@ViewOOrders')}}'" class="btn btn-info col-md-4" role="button">Ongoing Orders</button>
                        <br/><br/>
