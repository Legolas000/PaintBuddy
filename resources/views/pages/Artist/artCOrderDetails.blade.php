                ...
                {{--<div class="nav-tabs-custom">--}}
                    ...
                    <div class="tab-content">
                        ...
                        @if(isset($ordDetails))
                            ...
                            <label>Company</label>
                            <input type='text' class='form-control' readonly value="{!! $ordDetails->company !!}">
                            <label>Street</label>
                            <input type='text' class='form-control' readonly value="{!! $ordDetails->street !!}">
                            <label>City</label>
                            <input type='text' class='form-control' readonly value="{!! $ordDetails->city !!}">
                            <label>Country</label>
                            <input type='text' class='form-control' readonly value="{!! $ordDetails->country !!}">
                            <label>User Points</label>
                            <input type='text' class='form-control' readonly value="{!! $ordDetails->UsrRating !!}">
                        @else
